...
import {
  AnArrayOfStatements,
  anArrayOfStatementsSchema,
} from '../models/anArrayOfStatements';
import {
...
export class StatementsController extends BaseController {
   ...
   * @param startTime                Start date for use in retrieval of statements (ISO
   *                                                              8601)
   * @param endTime                  End date for use in retrieval of statements (ISO
   *                                                              8601)
  ...
  async getStatementList(
    ...
    req.throwOn(404, CustomError, '404 - Not found');
    ...
    return req.callAsJson(anArrayOfStatementsSchema, requestOptions);
  }
  ...
  async getStatements(
    ...
    req.throwOn(404, CustomError, 'Account exists but contains no statements.');
    req.throwOn(405, ApiError, 'Method Not Allowed');
