...
import {
  ...
  transactionType4EnumSchema,
} from './transactionType4Enum';
...
export interface LocTransaction {
  ...
  /** LocTransaction Type */
  transactionType?: TransactionType4Enum;
}

export const locTransactionSchema: Schema<LocTransaction> = object({
  ...
  transactionType: ['transactionType', optional(transactionType4EnumSchema)],
});
