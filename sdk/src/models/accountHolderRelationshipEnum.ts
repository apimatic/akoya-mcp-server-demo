...
/**
 * Enum for AccountHolderRelationshipEnum
 */
export enum AccountHolderRelationshipEnum {
...
/**
 * Schema for AccountHolderRelationshipEnum
 */
export const accountHolderRelationshipEnumSchema: Schema<AccountHolderRelationshipEnum> = stringEnum(
