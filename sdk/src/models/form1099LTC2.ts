...
import { NameAndAddress1, nameAndAddress1Schema } from './nameAndAddress1';
...
export const form1099LTC2Schema: Schema<Form1099LTC2> = object({
  ...
  insuredNameAddress: [
    'insuredNameAddress',
    optional(lazy(() => nameAndAddress1Schema)),
  ],
