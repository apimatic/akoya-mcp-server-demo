...
import {
  ...
  stateAndLocalTaxWithholding2Schema,
} from './stateAndLocalTaxWithholding2';
...
export interface Form1099PATR2 {
...
export const form1099PATR2Schema: Schema<Form1099PATR2> = object({
  ...
  nonpatronageDistributions: ['nonpatronageDistributions', optional(number())],
  ...
  otherCreditsAndDeductions: ['otherCreditsAndDeductions', optional(number())],
  specifiedCoop: ['specifiedCoop', optional(boolean())],
  stateAndLocal: [
    'stateAndLocal',
    optional(lazy(() => stateAndLocalTaxWithholding2Schema)),
  ],
