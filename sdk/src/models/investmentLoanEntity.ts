...
import {
  ...
  loanPaymentFrequencyEnumSchema,
} from './loanPaymentFrequencyEnum';
...
export interface InvestmentLoanEntity {
  ...
  loanPaymentFrequency?: LoanPaymentFrequencyEnum;
...
export const investmentLoanEntitySchema: Schema<InvestmentLoanEntity> = object({
  ...
  loanPaymentFrequency: [
    'loanPaymentFrequency',
    optional(loanPaymentFrequencyEnumSchema),
  ],
