...
/**
 * Enum for TypeFormType2Enum
 */
export enum TypeFormType2Enum {
...
/**
 * Schema for TypeFormType2Enum
 */
export const typeFormType2EnumSchema: Schema<TypeFormType2Enum> = stringEnum(
  TypeFormType2Enum
);
