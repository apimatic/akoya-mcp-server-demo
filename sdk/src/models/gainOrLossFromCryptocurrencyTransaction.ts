...
import {
  SaleTermType3Enum,
  saleTermType3EnumSchema,
} from './saleTermType3Enum';
...
export interface GainOrLossFromCryptocurrencyTransaction {
  ...
  longOrShort?: SaleTermType3Enum;
}

export const gainOrLossFromCryptocurrencyTransactionSchema: Schema<GainOrLossFromCryptocurrencyTransaction> = object(
  {
    ...
    longOrShort: ['longOrShort', optional(saleTermType3EnumSchema)],
  }
);
