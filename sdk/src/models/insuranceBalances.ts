...
import {
  AccountCategoryEnum,
  accountCategoryEnumSchema,
} from './accountCategoryEnum';
...
import {
  ...
  policyPremiumTermEnumSchema,
} from './policyPremiumTermEnum';
...
export interface InsuranceBalances {
  ...
  policyPremiumTerm?: PolicyPremiumTermEnum;
  /** The premium start date. */
  policyStartDate?: string;
}

export const insuranceBalancesSchema: Schema<InsuranceBalances> = object({
  ...
  accountCategory: ['accountCategory', optional(accountCategoryEnumSchema)],
  ...
  policyPremiumTerm: [
    'policyPremiumTerm',
    optional(policyPremiumTermEnumSchema),
  ],
