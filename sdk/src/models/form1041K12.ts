...
import { TaxParty2, taxParty2Schema } from './taxParty2';
...
export const form1041K12Schema: Schema<Form1041K12> = object({
  ...
  fiduciary: ['fiduciary', optional(lazy(() => taxParty2Schema))],
  amtAdjustments: [
    'amtAdjustments',
    optional(array(lazy(() => codeAndAmountSchema))),
  ],
