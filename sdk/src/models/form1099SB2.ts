...
import {
  ...
  nameAddressAndPhone2Schema,
} from './nameAddressAndPhone2';
...
export const form1099SB2Schema: Schema<Form1099SB2> = object({
  ...
  contactNameAddress: [
    'contactNameAddress',
    optional(lazy(() => nameAddressAndPhone2Schema)),
  ],
});
