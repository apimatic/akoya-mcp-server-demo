...
import { IncomeTypeEnum, incomeTypeEnumSchema } from './incomeTypeEnum';
import {
  Inv401kSource1Enum,
  inv401kSource1EnumSchema,
} from './inv401kSource1Enum';
import { LineItem, lineItemSchema } from './lineItem';
import { PositionTypeEnum, positionTypeEnumSchema } from './positionTypeEnum';
import {
  SecurityIdType3Enum,
  securityIdType3EnumSchema,
} from './securityIdType3Enum';
import { SecurityTypeEnum, securityTypeEnumSchema } from './securityTypeEnum';
import { Status1Enum, status1EnumSchema } from './status1Enum';
import {
  SubAccountFundEnum,
  subAccountFundEnumSchema,
} from './subAccountFundEnum';
import {
  SubAccountSecEnum,
  subAccountSecEnumSchema,
} from './subAccountSecEnum';
import {
  TransactionReasonEnum,
  transactionReasonEnumSchema,
} from './transactionReasonEnum';
import {
  TransactionType2Enum,
  transactionType2EnumSchema,
} from './transactionType2Enum';
import {
  TransferActionEnum,
  transferActionEnumSchema,
} from './transferActionEnum';
import { UnitType1Enum, unitType1EnumSchema } from './unitType1Enum';
...
export interface InvestmentTransaction {
  ...
  /** Source of money. */
  inv401kSource?: Inv401kSource1Enum;
  ...
  securityIdType?: SecurityIdType3Enum;
  ...
  subAccountFund?: SubAccountFundEnum;
  /** Sub-account security type. */
  subAccountSec?: SubAccountSecEnum;
  /** Ticker symbol. */
  symbol?: string;
  /** Taxes on the trade. */
  taxes?: number;
  ...
  transactionReason?: TransactionReasonEnum;
  /** InvestmentTransaction Type */
  transactionType?: TransactionType2Enum;
  /** Transfer direction. */
  transferAction?: TransferActionEnum;
...
export const investmentTransactionSchema: Schema<InvestmentTransaction> = object(
  {
    ...
    incomeType: ['incomeType', optional(incomeTypeEnumSchema)],
    inv401kSource: ['inv401kSource', optional(inv401kSource1EnumSchema)],
    ...
    securityIdType: ['securityIdType', optional(securityIdType3EnumSchema)],
    securityType: ['securityType', optional(securityTypeEnumSchema)],
    ...
    subAccountFund: ['subAccountFund', optional(subAccountFundEnumSchema)],
    subAccountSec: ['subAccountSec', optional(subAccountSecEnumSchema)],
    symbol: ['symbol', optional(string())],
    taxes: ['taxes', optional(number())],
    taxExempt: ['taxExempt', optional(boolean())],
    transactionReason: [
      'transactionReason',
      optional(transactionReasonEnumSchema),
    ],
    transactionType: ['transactionType', optional(transactionType2EnumSchema)],
    transferAction: ['transferAction', optional(transferActionEnumSchema)],
    unitPrice: ['unitPrice', optional(number())],
    units: ['units', optional(number())],
    unitType: ['unitType', optional(unitType1EnumSchema)],
