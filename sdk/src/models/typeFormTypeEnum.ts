...
/**
 * Enum for TypeFormTypeEnum
 */
export enum TypeFormTypeEnum {
...
/**
 * Schema for TypeFormTypeEnum
 */
export const typeFormTypeEnumSchema: Schema<TypeFormTypeEnum> = stringEnum(
  TypeFormTypeEnum
);
