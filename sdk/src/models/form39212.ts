...
import { TaxParty4, taxParty4Schema } from './taxParty4';
...
export const form39212Schema: Schema<Form39212> = object({
  ...
  corporation: ['corporation', optional(lazy(() => taxParty4Schema))],
});
