...
export const form1065K12Schema: Schema<Form1065K12> = object({
  ...
  recourseLiabilityShareEnd: ['recourseLiabilityShareEnd', optional(number())],
  ...
  capitalAccountWithdrawals: ['capitalAccountWithdrawals', optional(number())],
  ...
  unrecognizedSection704End: ['unrecognizedSection704End', optional(number())],
  ordinaryIncome: ['ordinaryIncome', optional(number())],
  netRentalRealEstateIncome: ['netRentalRealEstateIncome', optional(number())],
  otherRentalIncome: ['otherRentalIncome', optional(number())],
  guaranteedPaymentServices: ['guaranteedPaymentServices', optional(number())],
  ...
  multiplePassiveActivities: ['multiplePassiveActivities', optional(boolean())],
});
