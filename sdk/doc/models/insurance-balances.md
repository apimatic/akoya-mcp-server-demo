...
| `accountCategory` | [`AccountCategoryEnum \| undefined`](../../doc/models/account-category-enum.md) | Optional | The account category of the insurance account. Possible enums: DEPOSIT_ACCOUNT, INVESTMENT_ACCOUNT, LOAN_ACCOUNT, LOC_ACCOUNT, INSURANCE_ACCOUNT |
...
| `policyPremiumTerm` | [`PolicyPremiumTermEnum \| undefined`](../../doc/models/policy-premium-term-enum.md) | Optional | he payment term for the premium. MONTHLY or ANNUAL. |
