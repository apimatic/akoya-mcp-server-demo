...
This method returns an [`ApiResponse`](../../doc/api-response.md) instance. The `result` property of this instance returns the response data which is of type [Investments](../../doc/models/investments.md).
...
try {
  const { result, ...httpResponse } = await investmentsController.getAccounts(
  version,
  providerId,
...
This method returns an [`ApiResponse`](../../doc/api-response.md) instance. The `result` property of this instance returns the response data which is of type [TaxlotsAccountIdHoldingIdResponse](../../doc/models/taxlots-account-id-holding-id-response.md).
...
try {
  const { result, ...httpResponse } = await investmentsController.getTaxlots(
  version,
  providerId,
  accountId,
  holdingId,
...
|  --- | --- | --- |
| 401 | Customer not authorized. | [`CustomError`](../../doc/models/custom-error.md) |
| 403 | The `providerId` is wrong or your app doesn't have a subscription to the provider. | [`CustomError`](../../doc/models/custom-error.md) |
| 404 | 701 - Tax Lots not found. The `holdingId` may be wrong. | [`CustomError`](../../doc/models/custom-error.md) |
| 405 | Method Not Allowed | `ApiError` |
| 408 | Request timed out (round trip call took >10 seconds). | [`CustomError`](../../doc/models/custom-error.md) |
