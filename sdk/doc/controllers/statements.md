...
): Promise<ApiResponse<AnArrayOfStatements>>
```
...
This method returns an [`ApiResponse`](../../doc/api-response.md) instance. The `result` property of this instance returns the response data which is of type [AnArrayOfStatements](../../doc/models/an-array-of-statements.md).
...
try {
  const { result, ...httpResponse } = await statementsController.getStatementList(
  accountId,
  version,
  providerId,
  startTime,
...
|  --- | --- | --- |
| 400 | Start or end date value is not in the ISO 8601 format. | [`CustomError`](../../doc/models/custom-error.md) |
| 404 | 404 - Not found | [`CustomError`](../../doc/models/custom-error.md) |
...
| HTTP Status Code | Error Description | Exception Class |
|  --- | --- | --- |
| 400 | Statement is processing and is not yet available. | [`CustomError`](../../doc/models/custom-error.md) |
| 404 | Account exists but contains no statements. | [`CustomError`](../../doc/models/custom-error.md) |
| 405 | Method Not Allowed | `ApiError` |
